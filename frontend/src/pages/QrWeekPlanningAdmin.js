...
function QrWeekPlanningAdmin() {
    ...
    fetch('/api/cours', {
      ...
      .then(async data => {
        ...
        for (const cours of data) {
          const res = await fetch(`/api/admin/professeurs-par-cours/${cours.nom}`, {
            headers: { Authorization: `Bearer ${localStorage.getItem('token')}` }
          });
 ...
 .map(cell => {
  ...
  return {
    ...
    try {
      const res = await fetch('/api/admin/qr-week-bulk', {
        method: 'POST',
        headers: {
  ...
  const handleGenerateQrCode = async () => {
    ...
    try {
      const res = await fetch('/api/admin/qr-day-generate', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          Authorization: `Bearer ${token}`
  ...
  const handleDeleteQrCode = async () => {
    ...
    try {
      const res = await fetch(`/api/admin/qr-day-delete`, {
        method: 'DELETE',
        headers: {
          'Content-Type': 'application/json',
          Authorization: `Bearer ${token}`
  ...
  const handleGetDaySessions = async () => {
    ...
    try {
      const res = await fetch(`/api/admin/qr-day-sessions?date=${dayDate}`, {
  ...
  const handleUpdateSession = async (sessionId, updatedData) => {
    ...
    try {
      const res = await fetch(`/api/admin/qr-session/${sessionId}`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
          Authorization: `Bearer ${token}`
