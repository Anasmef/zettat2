...
import { User, Lock, Mail, Eye, EyeOff, CheckCircle, AlertCircle } from 'lucide-react';
...
const EtudiantProfil = () => {
  ...
  const [etudiantInfo, setEtudiantInfo] = useState({ prenom: '', nomDeFamille: '', email: '' });
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        setEtudiantInfo(prev => ({ ...prev, email: data.etudiant.email }));
      } else {
      ...
      <div style={{
        ...
        <div style={{
          ...
          <p style={{
            ...
            Bonjour {etudiantInfo.prenom} {etudiantInfo.nomDeFamille}
          </p>
        </div>
