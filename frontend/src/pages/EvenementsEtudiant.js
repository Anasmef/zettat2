  ...
  useEffect(() => {
    const fetchEvenements = async () => {
      try {
        ...
        const res = await axios.get('/api/evenements/public', {
      ...
      <div style={styles.content}>
        <div style={{
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', width: '100%', textAlign: 'center' }}>
            <h1 style={{ ...styles.title, textAlign: 'center', width: '100%', display: 'flex', justifyContent: 'center' }}>
              Événements Publics
            </h1>
              ...
              >
                ...
                <div style={styles.eventInfo}>
                  <div style={styles.infoItem}>
                    <Calendar style={styles.infoIcon} size={16} color="#10b981" />
                    <span>
    ...
    <span>
      <strong>Date de fin:</strong> {new Date(e.dateFin).toLocaleDateString('fr-FR', {
        ...
        day: 'numeric'
                  ...
                  {e.description && (
                    <div style={styles.infoItem}>
                      <FileText style={styles.infoIcon} size={16} color="#3b82f6" />
                      <span>
...
export default EvenementsEtudiant;